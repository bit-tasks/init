...
1. Create a new [secret variable](https://docs.github.com/en/actions/security-guides/encrypted-secrets) for either `BIT_CLOUD_ACCESS_TOKEN`([docs](https://bit.dev/reference/ci/github-actions#generating-an-access-token)) or `BIT_CONFIG_USER_TOKEN`([docs](https://bit.dev/reference/reference/config/bit-config/#modify-a-configuration-value)) and use it as an [environment variable](https://docs.github.com/en/actions/learn-github-actions/variables) in your GitHub Action.
