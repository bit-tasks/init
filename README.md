...
1. Create a new [secret variable](https://docs.github.com/en/actions/security-guides/encrypted-secrets) for either `BIT_CLOUD_ACCESS_TOKEN` or `BIT_CONFIG_USER_TOKEN` and use it as an [environment variable](https://docs.github.com/en/actions/learn-github-actions/variables) in your GitHub Action. For more information, refer [access tokens](https://bit.dev/reference/ci/github-actions#access-tokens) section in the documentation.
