...
1. Create a new [secret variable](https://docs.github.com/en/actions/security-guides/encrypted-secrets) for either `BIT_CLOUD_ACCESS_TOKEN` or `BIT_CONFIG_USER_TOKEN` and use it as an [environment variable](https://docs.github.com/en/actions/learn-github-actions/variables) in your GitHub Action. For more information on generating bit tokens, refer [bit config](https://bit.dev/reference/config/bit-config) documentation.
